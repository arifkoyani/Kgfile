...
const ImageToWebpConverter = () => {
  ...
  return (
    <div className="p-4 border rounded-lg shadow-md w-96 text-center">
      <h2 className="text-lg font-bold mb-2">Image to WebP Converter</h2>
      <input type="file" accept="image/*" onChange={handleFileChange} className="mb-2" />
      {convertedUrl && (
        <div className="mt-4">
          <img src={convertedUrl} alt="Converted WebP" className="w-full h-auto mb-2" />
          <a
            href={convertedUrl}
